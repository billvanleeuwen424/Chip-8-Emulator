...
class chip8{
    public:
        ...
        u_int8_t memory[MEMORYSIZE] = {0};
        u_int8_t generalRegisters[REGISTERCOUNT] = {0};
        
        u_int16_t stack[STACKSIZE] = {0};
        u_int16_t * stackPointer = &stack[0]; 
         ...
         *         merges them into an u_int16_t, and returns it.
         * @param  programCounter: the memory location to fetch from. 
         * @retval returnValue:
         */
        u_int16_t fetch(u_int16_t programCounter){
            
            u_int16_t returnValue = 0;
         ...
         * @retval None
         */
        void decodeExecute(u_int16_t opcode){
